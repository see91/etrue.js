...
var tests = [
    {
        ...
        // signature from etrue_signTransaction
    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must compare to etrue_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction using the iban as \"to\" must compare to etrue_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction will call for nonce", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        ...
                        assert.equal(payload.method, 'etrue_getTransactionCount');
